    ...
    <!-- Begin Page Content -->
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Edit Waktu Operasional</h1>
            </div>
            ...
            <div class="card-shadow">
                <div class="card-body">
                    <form action="{{ route('working-hour.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="hours" value="{{ $item->hours }}" required />
                        </div>
